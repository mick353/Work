...
export const closureFlashcards: Flashcard[] = [
  ...
  { id: "cf67", moduleId: "openitems", kind: "definition", front: "What should the closure signature attest to?", back: "That the transfers described have been accepted by the owners named. That makes signing consequential — an unowned benefit is a transfer the signatory is declining." },
  ...
  { id: "cf74", moduleId: "openitems", kind: "discrimination", front: "Stakeholder feedback is unanimously positive. Suspect what?", back: "The wrong people were asked, or dissent was not reported. Any change of substance produces someone who disliked it, and that is the part with information in it." },
...
export const closureFieldGuide: FieldGuideEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { term: "What the PPO does with it", detail: "Nothing that helps you. Reports are not reviewed for approval or compliance; information is aggregated to identify trends and opportunities for organisational improvement." },
    ],
  },
  {
    id: "tiers",
  ...
  },
  {
    ...
    items: [
      ...
      { term: "10. Outcomes", detail: "The objectives and target outcomes from the approved PMP, each with a responsible business owner, plus maintenance, realisation monitoring and transition arrangements. Failed by naming a branch instead of a person who accepted." },
      ...
      { term: "12. Change Control", detail: "How the formal change process was managed and the decisions taken, with the Change Register attached. Failed when no change was ever refused, which describes a gate that approved everything." },
...
export const closureDivergences: Divergence[] = [
  ...
  },
  {
    ...
    why: "The report is the artefact that closes the project, and nobody downstream reviews it. Whether it is usable is decided entirely by how it is written.",
  },
  {
    id: "cdv5",
