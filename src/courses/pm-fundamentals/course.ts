...
export const sources: Source[] = [
  ...
  },
  {
    ...
    note: "Public article and the direct source of the 'build trap' framing behind outputs-versus-outcomes. Melissa Perri is named in the deck's recommended reading on slide 97.",
    checked: CONTENT_REVIEWED,
  },
  {
    id: "cddo",
    title: "Product manager — Government Digital and Data Profession Capability Framework",
    publisher: "UK Government / Government Digital and Data Profession",
    url: "https://ddat-capability-framework.service.gov.uk/role/product-manager",
    note: "Public government comparator covering product-manager responsibilities and skills from associate to head of product: value, outcomes, user and business needs, evidence, prioritisation, lifecycle management and product leadership.",
    checked: CONTENT_REVIEWED,
  },
  {
    id: "servicemanual",
