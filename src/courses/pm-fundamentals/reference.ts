...
export const flashcards: Flashcard[] = [
  ...
  { id: "f14", moduleId: "discovery", kind: "application", front: "Discovery has produced a 60-page report recommending a mobile app. What are the two failures?", back: "The recommendation is not traceable to the evidence, and an untested idea has been presented as a decision. Discovery may record solution hypotheses, but must keep evidence, options and recommendations distinguishable." },
  ...
  { id: "f19", moduleId: "outcomes", kind: "definition", front: "Leading indicator", back: "An earlier measure expected to predict a named later outcome. The relationship and time horizon must be stated and validated; no metric is inherently leading in every context." },
  { id: "f20", moduleId: "outcomes", kind: "definition", front: "Lagging indicator", back: "A measure that confirms the named outcome after it has occurred. The same metric may lead one result and lag another, depending on the causal chain and time horizon." },
  ...
  { id: "f35", moduleId: "delivery", kind: "definition", front: "Product Backlog — Scrum and local DES practice", back: "Scrum: an emergent, ordered list and the Scrum Team's single source of work, with the Product Owner accountable for effective management and value. Local DES practice: team members contribute work through the agreed process and product management maintains the value order." },
  ...
  { id: "f38", moduleId: "delivery", kind: "definition", front: "Epic — minimum DES detail", back: "Hypothesis; description; business outcomes and benefits; OKRs; desired delivery period; in/out of scope; dependencies; sizing estimate. A measurable outcome spanning multiple PIs or teams." },
  { id: "f39", moduleId: "delivery", kind: "definition", front: "Feature — minimum DES detail", back: "Description and hypothesis; sizing estimate; acceptance criteria; in/out of scope; feature measurement; risks, issues and dependencies; area and iteration path. Demonstrable within a PI." },
  { id: "f40", moduleId: "delivery", kind: "definition", front: "Story — minimum DES detail", back: "As a [persona] I want [goal] so that [reason]; acceptance criteria; story points; area path; iteration path aligned to the expected sprint; related work linked to the parent feature." },
  ...
  { id: "f43", moduleId: "delivery", kind: "application", front: "While the team delivers PI N, what discovery runway does the local DES model maintain?", back: "Shared discovery and solution exploration for likely PI N+1 work, while evidence from current delivery can still change the plan. It is a planning heuristic, not a separate discovery handoff." },
  ...
  { id: "f54", moduleId: "roles", kind: "definition", front: "Product Owner horizon in the local deck", back: "The deck emphasises backlog management, story refinement, acceptance criteria, sprint support and clarifying requirements. Scrum accountability is broader: maximizing product value, the Product Goal and effective Product Backlog management." },
  ...
  { id: "f61", moduleId: "government", kind: "definition", front: "Start with the problem — practical implication", back: "Understand user needs, policy intent and root causes before committing. The principle number is reference information; the capability is using it in a decision." },
  { id: "f62", moduleId: "government", kind: "definition", front: "Design for the whole service — practical implication", back: "Optimise the end-to-end experience across channels and systems, not individual projects. Reuse before rebuild. The principle number is reference information, not a learning objective." },
  ...
  { id: "f88", moduleId: "roles", kind: "discrimination", front: "Every decision is going to the Project Board. What is the cost?", back: "Board capacity is spent on reversible detail, so material risk gets less attention, and the team learns not to decide anything. Push reversible decisions down." },
  ...
  { id: "f91", moduleId: "integration", kind: "discrimination", front: "How do you know a roadmap item is justified?", back: "Trace it back to a user or service problem with evidence, and forward to a measure that would show whether it worked. If either end is missing, priority is unjustifiable." },
...
export const fieldGuide: FieldGuideEntry[] = [
  {
    ...
    items: [
      ...
      { term: "Delivery", detail: "Building and releasing increments. Product contribution: protecting the outcome, maintaining shared discovery runway and adapting the order as evidence changes." },
  ...
  },
  {
    ...
    summary: "One of three DES Ways of Working foundations, alongside the Digital Delivery Framework and Methods.",
    slides: "87",
    sourceIds: ["deck"],
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { term: "Epic fields", detail: "Hypothesis; description; business outcomes and benefits; OKRs; desired delivery period; in/out of scope; dependencies; sizing estimate." },
      { term: "Feature fields", detail: "Description and hypothesis; sizing estimate; acceptance criteria; in/out of scope; feature measurement; risks/issues/dependencies; area and iteration path." },
      { term: "Story fields", detail: "As a [persona] I want [goal] so that [reason]; acceptance criteria; story points; area path; iteration path; related work linked to the parent feature." },
  ...
  },
  {
    ...
    items: [
      ...
      { term: "Product Owner — local deck emphasis", detail: "Backlog management, refinement, acceptance criteria and sprint support. Scrum retains the Product Owner's broader accountability for product value, the Product Goal and effective backlog management." },
...
export const diagnosticQuestions: Question[] = [
  ...
  { id: "dx-roles4", moduleId: "roles",
    ...
    answer: 1,
    optionNotes: [
      "In the local deck's split, this is mainly Product Owner work. Doing it full time leaves nobody on the longer horizon.",
      "",
    ...
    rationale: "In the local deck's operating model, detailed acceptance criteria sit mainly with the Product Owner and team. When the Product Manager absorbs that work, the longer-horizon questions go unasked — which is how a team delivers competently in the wrong direction." },
...
export const glossary: GlossaryEntry[] = [
  ...
  { term: "Discovery", origin: "Deck", moduleId: "discovery", definition: "Work that reduces uncertainty about users, problems, opportunities and solution risks. Its primary outputs are evidence, insight and hypotheses; candidate solutions remain unselected and unproven until exploration tests them." },
  ...
  { term: "Epic", origin: "Deck", moduleId: "delivery", definition: "In the local DES hierarchy, a measurable business outcome spanning multiple PIs or teams. Minimum detail includes hypothesis, description, outcomes and benefits, OKRs, delivery period, scope, dependencies and sizing." },
  ...
  { term: "Feature", origin: "Deck", moduleId: "delivery", definition: "In the local DES hierarchy, a tangible outcome contributing to an epic and demonstrable within a PI. Minimum detail includes description, hypothesis, sizing, acceptance criteria, scope, measurement, risks/issues/dependencies and area/iteration path." },
  ...
  { term: "Lagging indicator", origin: "General", moduleId: "outcomes", definition: "A measure that confirms the named outcome after it has occurred. The label depends on the outcome and time horizon, not the metric alone." },
  { term: "Leading indicator", origin: "General", moduleId: "outcomes", definition: "An earlier measure expected to predict a named later outcome. The relationship and time horizon must be stated and validated." },
  ...
  { term: "Product Backlog", origin: "Scrum", moduleId: "delivery", definition: "An emergent, ordered list of what is needed to improve the product and the Scrum Team's single source of work. The Product Owner is accountable for effective management and value; the deck separately describes local DES contribution and ordering practice." },
  ...
  { term: "Product Owner", origin: "Scrum", moduleId: "roles", definition: "Accountable for maximizing product value, the Product Goal and effective Product Backlog management. The local deck emphasises refinement, acceptance criteria and sprint support within a separate Product Manager/Product Owner model." },
  ...
  { term: "Story", origin: "Deck", moduleId: "delivery", definition: "In the local DES hierarchy, a small slice a team can complete and validate in a sprint. Includes the as-a/I-want/so-that description, acceptance criteria, points, area path, iteration path and related work linked to its parent feature." },
  ...
  { term: "Ways of Working", origin: "Deck", moduleId: "government", definition: "Three foundations: behaviours; the Digital Delivery Framework and its planning, governance, discipline and collaboration principles; and Methods combining Design Thinking, Project Management, Agile and Lean." },
...
export const supplementaryQuestions: Question[] = [
  ...
  },
  {
    ...
    answer: 0,
    optionNotes: [ "", "Concerning, but the ordering could still be correct.", "Multiple contributors can propose backlog items. The accountable Product Owner orders the Product Backlog in Scrum; local teams may define how Product Management and delivery roles contribute.","Size alone is normal for a long-lived product."],
  ...
  },
  {
    ...
    prompt: "The DES principle 'decisions belong closest to the problem' requires what of governance?",
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        insight:
          "Completion rate was not a bad measure. It was an early behavioural signal being treated as the final outcome without evidence that it predicted successful vacancy filling. That relationship—not an intrinsic label on the metric—is the point of stage 3.",
      },
    ],
    closing:
