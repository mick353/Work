...
export const sources: Source[] = [
  ...
  },
  {
    ...
    note: "Clear outcome, ongoing interviews, opportunity mapping and assumption testing by a product trio.",
    checked: CONTENT_REVIEWED,
  },
  {
    id: "svpg",
  ...
  },
  {
    ...
    note: "Named in the deck's recommended reading (slide 97) for product strategy and organisational alignment; the source of the 'build trap' framing behind outputs-versus-outcomes.",
    checked: CONTENT_REVIEWED,
  },
  {
    id: "pichler",
