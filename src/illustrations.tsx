...
export const stageIllustrations: Record<string, (props: Props) => React.ReactElement> = {
  ...
  "pm-fundamentals:discovery": IllusDiscoveryFunnel,
  "pm-fundamentals:outcomes": IllusOutputToOutcome,
  "pm-fundamentals:exploration": IllusDvf,
  "pm-fundamentals:delivery": IllusCadence,
  "pm-fundamentals:lifecycle": IllusLifecycleLoop,
  "pm-fundamentals:roles": IllusLayers,
  "pm-fundamentals:government": IllusPhaseGates,
  "pm-fundamentals:integration": IllusEvidenceChain,

  // Closure Reports
  "closure-reports:purpose": IllusClosurePurpose,
  "closure-reports:process": IllusClosureProcess,
  "closure-reports:accountability": IllusApprovalChain,
  "closure-reports:deliverables": IllusTwoDeliverables,
  "closure-reports:milestones": IllusBaselineVariance,
  "closure-reports:evidence": IllusClaimStrength,
  "closure-reports:benefits": IllusBenefitLag,
  "closure-reports:lessons": IllusLessonShape,
  "closure-reports:handover": IllusHandoverTest,
  "closure-reports:financial": IllusCapitalise,
  "closure-reports:records": IllusShutdown,
  "closure-reports:sections": IllusThreeLevels,
  "closure-reports:openitems": IllusThreeDestinations,
  "closure-reports:writing": IllusOnePage,
  "closure-reports:assurance": IllusEvidenceLinks,
};
