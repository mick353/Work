...
**Start blank course** and the sidebar **New course** control reset the current browser draft. When the draft contains course work, the Workshop warns that it will be replaced and recommends downloading it first; cancelling preserves the current draft unchanged. An untouched starter can move directly to Course setup without an unnecessary warning.
