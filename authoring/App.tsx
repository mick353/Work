    ...
    return <div className="workspace-stack">
      ...
      <Card title="Generate outputs" eyebrow="Choose the delivery route">
        ...
        <div className="export-grid">
          ...
          <article><div className="export-icon"><FileJson size={24} /></div><h3>Complete editable draft</h3><p>A portable JSON checkpoint that another trainer can load and continue. It includes stable draft identity, revision, embedded slides, images and the current review checklist. Its filename records the course version, draft revision, date and time. Approximately {draftSizeLabel}; it is never a learner course.</p><button type="button" className="secondary" onClick={downloadPortableDraft}><Save size={17} />Download complete draft</button></article>
        </div>
      </Card>
