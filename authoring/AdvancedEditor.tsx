...
function EditorGroup({ title, description, children, addLabel, onAdd }: { title: string; description: string; children: React.ReactNode; addLabel: string; onAdd: () => void }) {
  return (
    <section className="editor-card advanced-group">
...
export function AdvancedEditor({ entry, setEntry }: Props) {
  ...
  return (
    <div className="workspace-stack">
      ...
      <EditorGroup title="Worked cases" description="Show one realistic situation developing across course stages. A corrected case can deliberately expose and repair a weak first attempt." addLabel="Add case" onAdd={addCase}>
      ...
      <EditorGroup title="Toolkit templates" description="Give learners a reusable prompt, structure or mini-template with an example of a good response." addLabel="Add tool" onAdd={addToolkit}>
      ...
      <EditorGroup title="Capstone" description="Create one or more briefs, the learner's ordered production steps and a transparent rubric. The three parts travel together." addLabel="Add brief" onAdd={addBrief}>
      ...
      <EditorGroup title="Field guide" description="Build concise reference entries learners can return to after the course. Source locators can open an imported source deck." addLabel="Add guide entry" onAdd={addGuide}>
      ...
      <EditorGroup title="Source differences" description="Record where the course deliberately explains, updates or applies source material differently. This prevents silent divergence." addLabel="Add difference" onAdd={addDivergence}>
      ...
      <EditorGroup title="Worked documents and exemplars" description="Show the whole artefact a learner is expected to produce. Sections can contain paragraphs, a table, an artefact block and a coaching note." addLabel="Add exemplar" onAdd={addExemplar}>
